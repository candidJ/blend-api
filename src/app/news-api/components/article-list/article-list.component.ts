...
import { NewsApiService } from "src/app/news-api/services/news-api.service";
import { IGridColumnsDef } from "src/app/news-api/types/hacker-news.interface";
...
export class ArticleListComponent implements OnInit {
  ...
  public paginationConfig$: Observable<PaginationConfig> =
    this.newsApiServie.paginationConfig$;
